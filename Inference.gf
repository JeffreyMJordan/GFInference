...
data
  ...
  plus_AdV, minus_AdV, neutral_AdV, down_AdV, up_AdV, neither_AdV : AdV;
  
  AdjCN : AP -> CN -> CN ;
  up_A, down_A, neither_A : A ;
  
  down_adv, up_adv, neither_adv : Adv ;
...
--  decorate (UseCl pol (PredVP np vp)) = 
  ...
  def
   decorate (UseCl pol (PredVP np vp)) = 
     UseCl pol (evalNP np vp pol);
     
     
  fun
    evalNP : NP -> VP -> Pol -> Cl ;
  def
    evalNP (DetCN (DetQuant no_Quant num) cn) vp  pol = 
    	PredVP (DetCN (DetQuant no_Quant num) cn) (evalVPNeg (valPol pol) vp);
    evalNP np vp pol = 
      PredVP np (evalVP (valPol pol) vp);
  ...
  fun
    evalVPNeg : Val -> VP -> VP ;
  def
    evalVPNeg val (ComplVV vv pol vp) = 
      ComplVV vv pol 
      	(AdVVP  (evalAdV (oppVal (joinVal val (valVV vv))) ) (evalVP (oppVal (joinVal (valPol pol) (joinVal val (valVV vv)))) vp) );
  ...
  def
   ...
   def
     ...
     evalDetCNVP someSg_Det cn (UseComp (CompCN cn2))  = 
     	PredVP (DetCN someSg_Det (AdjCN (PositA up_A) cn)) (UseComp (CompCN (AdjCN (PositA up_A) cn2))) ;
     	
     evalDetCNVP somePl_Det cn (UseComp (CompCN cn2))  = 
     	PredVP (DetCN somePl_Det (AdjCN (PositA up_A) cn)) (UseComp (CompCN (AdjCN (PositA up_A) cn2))) ;
     	
     evalDetCNVP few_Det cn (UseComp (CompCN cn2))  = 
     	PredVP (DetCN few_Det (AdjCN (PositA neither_A) cn)) (UseComp (CompCN (AdjCN (PositA down_A) cn2))) ;
     	
     evalDetCNVP many_Det cn (UseComp (CompCN cn2))  = 
     	PredVP (DetCN many_Det (AdjCN (PositA neither_A) cn)) (UseComp (CompCN (AdjCN (PositA up_A) cn2))) ;
    	
      evalDetCNVP every_Det cn (ComplVV vv pol vp) = 
      	PredVP (DetCN every_Det (AdjCN (PositA down_A) (AdvCN cn down_adv))) (evalVP2 (ComplVV vv pol vp)) ;
    	
      evalDetCNVP someSg_Det cn (ComplVV vv pol vp) = 
      	PredVP (DetCN someSg_Det (AdjCN (PositA up_A) (AdvCN cn down_adv))) (evalVP2 (ComplVV vv pol vp)) ;
      	
     evalDetCNVP somePl_Det cn (ComplVV vv pol vp) = 
      	PredVP (DetCN somePl_Det (AdjCN (PositA up_A) (AdvCN cn down_adv))) (evalVP2 (ComplVV vv pol vp)) ;
    	
    	
   	  evalDetCNVP few_Det cn (ComplVV vv pol vp) = 
   	  	PredVP (DetCN few_Det (AdjCN (PositA neither_A ) (AdvCN cn down_adv))) (evalVP2 (ComplVV vv pol vp)) ;
    	
      evalDetCNVP many_Det cn (ComplVV vv pol vp) = 
   	  	PredVP (DetCN many_Det (AdjCN (PositA neither_A ) (AdvCN cn down_adv))) (evalVP2 (ComplVV vv pol vp)) ;
    	
    	
      evalDetCNVP every_Det cn (UseV v) = 
      	PredVP (DetCN every_Det (AdjCN (PositA down_A) (AdvCN cn down_adv))) (UseV v) ; 
      	
      evalDetCNVP someSg_Det cn (UseV v) = 
      	PredVP (DetCN someSg_Det (AdjCN (PositA up_A) (AdvCN cn up_adv))) (UseV v) ; 
      	
      evalDetCNVP somePl_Det cn (UseV v) = 
      	PredVP (DetCN somePl_Det (AdjCN (PositA up_A) (AdvCN cn up_adv))) (UseV v) ; 
    	
     evalDetCNVP few_Det cn (UseV v) = 
      	PredVP (DetCN few_Det (AdjCN (PositA neither_A) (AdvCN cn neither_adv))) (UseV v) ; 
      	
      evalDetCNVP many_Det cn (UseV v) = 
      	PredVP (DetCN many_Det (AdjCN (PositA neither_A) (AdvCN cn neither_adv))) (UseV v) ; 
   fun
     evalVP2 : VP -> VP ;
   def
